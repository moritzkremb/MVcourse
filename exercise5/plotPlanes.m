function plotPlanes(p, a, b, c, d, inliers, colours)
% Plot planes, using information about inliers and points to
% define bounds
% p: points in the cloud
...
for i = 1:nplanes
    ...
    z = PlaneZFromXY(x, y, a(i), b(i), c(i), d(i));
...
if ~isscalar(mean_normal)
    ...
    z = PlaneZFromXY(x, y, mean_normal(1), mean_normal(2), mean_normal(3), mean(d));
